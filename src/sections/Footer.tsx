...
const footerLinks = [
  {
    title: "LinkedIn",
    href: "https://www.linkedin.com/in/satyam-shukla-970842177/",
    icon: <LinkedInIcon className="size-4" />,
  },
  {
    title: "GitHub",
    href: "https://github.com/Satyam-Git345",
    icon: <GithubIcon className="size-4" />,
  },
  {
    title: "Instagram",
    href: "https://www.instagram.com/mr_daring56/profilecard/?igsh=dGFudmZ1ZGNoeTYz/",
